...
- The `editMessageFormTemplate$` and `messageInputTemplate$` have been removed from the [`CustomTemplatesService`](../../services/CustomTemplatesService)
...
If you need more information, we have a [channel list guide](../../concepts/channel-list/) you can check out.
