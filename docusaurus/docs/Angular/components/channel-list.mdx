...
:::note
If you want to create your own message list, you can use the [`ChannelService`](../services/channel.mdx) to receive the channels and interact with the Stream API.
