...
We are using stream-chat theme variables to match the default chat theme. You can read more about theme variables in our [theming guide](../concepts/theming-and-css.mdx).
