...
[lib/message-list/image-load.service.ts:15](https://github.com/GetStream/stream-chat-angular/blob/4411374/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L15)
