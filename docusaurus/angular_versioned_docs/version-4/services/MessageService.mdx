...
[lib/message.service.ts:25](https://github.com/GetStream/stream-chat-angular/blob/4411374/projects/stream-chat-angular/src/lib/message.service.ts#L25)
...
[lib/message.service.ts:17](https://github.com/GetStream/stream-chat-angular/blob/4411374/projects/stream-chat-angular/src/lib/message.service.ts#L17)
