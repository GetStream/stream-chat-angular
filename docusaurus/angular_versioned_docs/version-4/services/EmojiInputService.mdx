...
[lib/message-input/emoji-input.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/4411374/projects/stream-chat-angular/src/lib/message-input/emoji-input.service.ts#L14)
