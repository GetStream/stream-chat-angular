...
```shell
npm install stream-chat-angular stream-chat @ngx-translate/core@13 angular-mentions@1.4.0 ngx-popperjs@13 --legacy-peer-deps
```

Run this command if you are using **Angular 12**:

```shell
npm install stream-chat-angular stream-chat @ngx-translate/core@13 angular-mentions@1.4.0 ngx-popperjs@12 --legacy-peer-deps
```
