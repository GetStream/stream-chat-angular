...
/**
 * The `StreamI18nService` can be used to customize the labels of the chat UI. Our [translation guide](/chat/docs/sdk/angular/v7-rc/concepts/translation/) covers this topic in detail.
 */
@Injectable({
  providedIn: 'root',
})
