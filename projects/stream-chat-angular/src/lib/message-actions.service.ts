...
/**
 * The message actions service provides customization options for the [message actions](/chat/docs/sdk/angular/v7-rc/components/MessageActionsBoxComponent)
 */
@Injectable({
  providedIn: 'root',
})
export class MessageActionsService {
  ...
  /**
   * By default the [`MessageComponent`](/chat/docs/sdk/angular/v7-rc/components/MessageComponent/) will display the [`MessageActionsBoxComponent`](/chat/docs/sdk/angular/v7-rc/components/MessageActionsBoxComponent/). You can override that behavior by providing your own event handler.
   */
