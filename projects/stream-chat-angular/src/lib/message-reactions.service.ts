...
export class MessageReactionsService {
   ...
   *
   * You can provide any string as a reaction. The emoji can be provided as a string, if you want to use custom images for reactions you have to provide a [custom reactions UI](/chat/docs/sdk/angular/v7-rc/services/CustomTemplatesService/#messagereactionstemplate/)
   */
  ...
  /**
   * By default the [`MessageReactionsComponent`](/chat/docs/sdk/angular/v7-rc/components/MessageReactionsComponent/) will display the reacting users when a reaction is clicked. You can override this with your own UI by providing a custom event handler.
   *
   * The event handler can retrieve all reactions of a message using the [`messageReactionsService.queryReactions()`](/chat/docs/sdk/angular/v7-rc/services/MessageReactionsService/#queryreactions)
   */
