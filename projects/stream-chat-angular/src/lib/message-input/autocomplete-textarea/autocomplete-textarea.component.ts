...
/**
 * The `AutocompleteTextarea` component is used by the [`MessageInput`](/chat/docs/sdk/angular/v7-rc/components/MessageInputComponent/) component to display the input HTML element where users can type their message.
 */
@Component({
  ...
  implements TextareaInterface, OnChanges, OnInit, AfterViewInit
{
  ...
  @Input() placeholder = '';
  /**
   * If true, users can mention other users in messages. You can also set this input on the [`MessageInput`](/chat/docs/sdk/angular/v7-rc/components/MessageInputComponent/#inputs-and-outputs/) component.
   */
  ...
  /**
   * The scope for user mentions, either members of the current channel of members of the application. You can also set this input on the [`MessageInput`](/chat/docs/sdk/angular/v7-rc/components/MessageInputComponent/#inputs-and-outputs) component.
   */
